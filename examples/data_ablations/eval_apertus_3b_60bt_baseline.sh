...
CKPT_PATH="/iopsstor/scratch/cscs/bmessmer/data_ablations/Megatron-LM/logs/Meg-Runs/data-ablations/apertus3-3b-64-nodes-phase-4-baseline/checkpoints/"

ITS=(0030000)
TOK_PER_IT=$(( 512 * 4096 ))
MODEL=apertus3-3b-64-nodes-phase-4-baseline
